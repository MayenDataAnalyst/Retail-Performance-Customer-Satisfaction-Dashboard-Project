...
🔗 **Live Dashboard:** [View on Looker Studio](https://lookerstudio.google.com/reporting/fe3e4967-6c5f-4cda-b03d-4a9bba624d33)

📂 **Data Source:** [View Google Sheet](https://docs.google.com/spreadsheets/d/1U33yJ_GFfFcZXDDZlBqDVOpjrIEe9Qj4YFbbi5SGBpg/edit?usp=sharing)
...
| Metric | Value |
|---|---|
| **Total Income** | 13,951,290 |
| **Quantity Ordered** | 53,800 |
| **Top Sale Product** | Retail Packaging |
| **Service Rating** | 13 |
...
- **Select Date Range** — Dynamically scope the data to a custom time period
...
3. Adjust the **Date Range** selector to analyze a custom time window
4. Hover over any chart element for detailed tooltips
5. Use the **Share** button (top-right) to share a live view with stakeholders
...
├── data/
│   └── customers_orders.csv    # Source data (if applicable)
├── assets/
│   └── dashboard_preview.gif   # Dashboard screenshot/preview
└── docs/
...
For questions or feedback on this dashboard, feel free to open an issue or reach out via [LinkedIn](https://www.linkedin.com).

---

> *Dashboard designed to support retail operations, logistics, and customer experience teams with real-time performance insights.*
```
